...
scripts/create_split.py:
    ...
    backbone_enc_256.onnx = backbone_256.onnx  ->  encoder.onnx
    dec_head_256.onnx     = decoder.onnx       ->  head_256.onnx
...
from scripts.bottleneck.modules import load_bottleneck  # noqa: E402

# The tensor name create_split.py cut on; both split halves use it as their boundary.
SPLIT_TENSOR = "/model.4/cv2/act/Mul_output_0"
...
def main():
    ...
    parser.add_argument("--backbone", default=str(ROOT / "models/split/backbone_256.onnx"))
    parser.add_argument("--head", default=str(ROOT / "models/split/head_256.onnx"))
