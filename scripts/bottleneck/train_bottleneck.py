"""
Stage 1: train the layer-4 bottleneck to reconstruct its own input.
...
def main():
    parser = argparse.ArgumentParser(description="Train the layer-4 reconstruction bottleneck")
    parser.add_argument("--feats", default=str(ROOT / "models/bottleneck/feats_256.npy"))
